...
final ThemeData dark = FlexThemeData.dark(
  colors: const FlexSchemeColor(
    primary: Color(0xff8dacdd),
    primaryContainer: Color(0xff1460a5),
    secondary: Color(0xffe6a073),
    secondaryContainer: Color(0xffd6783f),
    tertiary: Color(0xff959765),
    tertiaryContainer: Color(0xff6d6f34),
...
Color forGraphKey(GraphKey key) {
  final String seed = key.qid ?? key.title;
  ...
  final double s = 0.65 + ((hash.abs() % 20) / 100.0);

  final double l = 0.45 + ((hash.abs() % 20) / 100.0);
